...
export default function Home() {
  ...
  return (
    <main>
      ...
      <footer><a className="brand" href="#top"><span className="brand-mark">∴</span> 科学家日历</a><p>精选 {scientists.length} 位人物档案 · 持续更新中</p><a className="footer-download" href="print/科学家日历_精选80位_A4打印版.pdf" download>下载 A4 打印版 ↓</a><a href="#top">回到顶部 ↑</a></footer>
    </main>
  );
}
