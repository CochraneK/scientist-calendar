...
def draw_cover(c: canvas.Canvas) -> None:
    ...
    c.setFont(font(), 19)
    c.drawString(61, 93, "首批 30 位人物 · A4 横版打印样稿")
...
def draw_overview(c: canvas.Canvas, entries: list[dict[str, str]]) -> None:
    ...
    draw_text(c, "FIRST 30 SCIENCE NOTES", 76, H - 72, 8, MUTED, "latin")
    ...
    draw_text(c, "科学家日历 · 30 个好奇心的起点", W - 230, 29, 9, MUTED)
    c.showPage()
...
def draw_print_notes(c: canvas.Canvas) -> None:
    ...
    blocks = [
        ...
        ("内容说明", "本册收录首批 30 位科学人物与科学纪念日，作为内容样稿。正式印刷前，请逐条完成日期、事实、图片与来源复核。"),
    ]
    y = H - 135
    ...
    draw_text(c, "科学家日历 · 首批 30 位人物 · 2026 初版", 77, 81, 12, white)
