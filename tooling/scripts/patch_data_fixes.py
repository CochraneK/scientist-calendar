...
每一条修正都注明依据，便于回溯：
  ...
  7. 皮埃尔·德·费马 1月12日（误用卒日）-> 8月17日（出生日），生卒 1601–1665
     依据：本日历以出生日为锚点（如爱因斯坦 3/14）。Wikidata Q75655 出生 +1601-08-17、
           逝世 +1665-01-12；原 8 月 20 日为受洗日（1601-08-20），生日本为 8 月 17 日。
           此前误把卒日 1/12 当作生日，本次回正。8/17 已有玛格丽特·汉密尔顿（允许多占），
           1/12 仍有米歇尔·麦耶，365 天覆盖不变。
...
def main() -> int:
    ...
    # 费马：原 8/20 实为受洗日（1601-08-20），生日本为 1601-08-17；
    # 之前误改为 1/12（那是他的卒日 1665-01-12）。回正为出生 8/17、生卒 1601–1665。
    fermat = by_id["fermat"]
    if (fermat["month"], fermat["day"]) != (8, 17) or fermat["years"] != "1601–1665":
        print(f"皮埃尔·德·费马: {fermat['month']}月{fermat['day']}日 {fermat['years']} -> 8月17日 1601–1665（出生日，非卒日）")
        fermat["month"], fermat["day"] = 8, 17
        fermat["years"] = "1601–1665"
